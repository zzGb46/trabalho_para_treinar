        ...
        <div class="team-contant">
            ...
            <div class="teams" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="100"
                ...
                <div class="row row-cols-lg-3 row-cols-sm-2 row-cols-1 g-3 g-md-3">
                    <div class="col">
                        <div class="team-card ak-bg" data-src="assets/img/team_1.jpg">
                            <div class="team-style-1">
                                <div class="team-info">
                                    <div class="team-title">
                                        <a href="team-single.html">Michael Jack</a>
                                        <p class="desp">Founder CEO</p>
                                    </div>
                    ...
                    <div class="col">
                        <div class="team-card ak-bg" data-src="assets/img/team_2.jpg">
                            <div class="team-style-1">
                                <div class="team-info">
                                    <div class="team-title">
                                        <a href="team-single.html">Cathy Sparkman</a>
                                        <p class="desp">Main Mechanic</p>
                                    </div>
                                    <div class="team-info-social">
                                        <a href="https://www.facebook.com/" class="icon"><img
                                                src="assets/img/linkedinicon.svg" alt="..."></a>
                    ...
                    <div class="col">
                        <div class="team-card ak-bg" data-src="assets/img/team_3.jpg">
                            <div class="team-style-1">
                                <div class="team-info">
                                    <div class="team-title">
                                        <a href="team-single.html">Tyra Crawford</a>
                                        <p class="desp">Mechanic</p>
                                    </div>
                                    <div class="team-info-social">
                                        <a href="https://www.facebook.com/" class="icon"><img
                                                src="assets/img/linkedinicon.svg" alt="..."></a>
