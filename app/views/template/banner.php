                        ...
                        <div class="hero-slider-info">
                            <div class="slider-info">
                                <div class="hero-title">
                                    <h1 class="hero-main-title" data-swiper-parallax="300">Car Repair &
                                        Auto</h1>
                ...
                <div class="ak-hero ak-style1 slide-inner">
                    ...
                    <div class="container">
                        <div class="hero-slider-info">
                            <div class="slider-info">
                                <div class="hero-title">
                                    <h1 class="hero-main-title " data-swiper-parallax="300">AUTOMOTIVE REPAIR</h1>
                                    <h1 class="hero-main-title-1 style-2" data-swiper-parallax="100">MAINTENANCE</h1>
                                    <p class="mini-title" data-swiper-parallax="400">Our skilled team of certified
                                        technicians is here to provide
                                        top-notch car repair and auto services to ensure your vehicle performs at its
                                        best. Our skilled team of certified technicians.</p>
                ...
                <div class="ak-hero ak-style1  slide-inner">
                    ...
                    <div class="container">
                        <div class="hero-slider-info">
                            <div class="slider-info">
                                <div class="hero-title">
                                    <h1 class="hero-main-title" data-swiper-parallax="300">Car Repair & Auto</h1>
                                    <h1 class="hero-main-title-1 style-2" data-swiper-parallax="100">Services</h1>
                                    <p class="mini-title" data-swiper-parallax="400">Our skilled team of certified
                                        technicians is here to provide
                                        top-notch car repair and auto services to ensure your vehicle performs at its
                                        best. Our skilled team of certified technicians.</p>
            ...
            <div class="hero-contact-info">
                <a href="tel:(406)555-0120">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <p class="ak-font-18 ak-white-color ak-semi-bold">example@email.com</p>
                    </div>
                </a>
                <a href="#">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <p class="ak-font-18 ak-white-color ak-semi-bold">123 Maple Street Toronto, On, Canada</p>
                    </div>
                </a>
                <div class="d-flex align-items-center gap-2">
                    <div class="heartbeat-icon">
                    ...
                    <p class="ak-font-18 ak-white-color ak-semi-bold">Sun - Thu: Open 27/7</p>
                </div>
            </div>
        </div>
