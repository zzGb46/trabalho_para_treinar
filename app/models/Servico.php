...
class Servico extends Model
{
    ...
    public function getServicoPorLink($link){
     ...
     //Metodo para Pegar todos os serviços
     public function getServicos()
     {
 
         $sql = "select nome_servico, descricao_servico, link_servico from tbl_gabrielm_servico where status_servico = 'ativo' order by rand();";
